function generatePackageJson(answers) {
  const scripts = {
    ...
    'publish:patch':
      'npm run git && node node_modules/build-a-npm/publish.js --patch --npmjs --github',
    'publish:minor':
      'npm run git && node node_modules/build-a-npm/publish.js --minor --npmjs --github',
    'publish:major':
      'npm run git && node node_modules/build-a-npm/publish.js --major --npmjs --github',
    pub: 'npm run publish:patch',
    'pub:pat': 'npm run publish:patch',
    'pub:min': 'npm run publish:minor',
    'pub:maj': 'npm run publish:major',
    'nogit:patch':
      'node node_modules/build-a-npm/publish.js --patch  --npmjs --github',
    'nogit:minor':
      'node node_modules/build-a-npm/publish.js --minor  --npmjs --github',
    'nogit:major':
      'node node_modules/build-a-npm/publish.js --major  --npmjs --github',
    do: 'npm run git && node publish.js --patch --github --npmjs',
