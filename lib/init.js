  ...
  try {
    ...
    if (isGitHub) {
      if (answers.githubToken.toLowerCase() === 'na') {
        ...
        console.log(
          colorize(
            "1. Verify your GITHUB_TOKEN in .npmrc has the 'write:packages' and 'pages:write' scopes",
            '36'
          )
        );
      }
    ...
    console.log(
      colorize(`4. Run \`npm install\` to install dependencies`, '36')
    );
    if (isWindows) {
      console.log(
        colorize(
