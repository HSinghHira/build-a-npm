...
function generateGitHubPagesIndex(
  ...
  main = 'index.js',
  authorUrl = '' // Added for WEBSITE_URL logic
) {
  ...
  // Determine WEBSITE_URL: use authorUrl if provided, else repositoryUrl
  const websiteUrl = authorUrl || repositoryUrl;
...
<body>
  ...
  <div class="container">
    ...
    <main>
      ${htmlContent}
      <footer>
        <p>&copy; 2025 ${license} — ${title} — Build with ❤️ by ${authorName}</p>
        <p>This Package is Built with <a href="https://www.npmjs.com/package/build-a-npm" target="_blank">Build-a-NPM</a></p>
      </footer>
    </main>
  </div>
  <script>
