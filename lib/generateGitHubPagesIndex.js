...
<body>
  ...
  <div class="container">
    ...
    <main>
      ${htmlContent}
      <footer>
        <p>&copy; 2025 ${license} — ${title} — Created by <a href="https://${websiteUrl}" target="_blank">${authorName}</a></p>
        <p>Powered by ❤️ & <a href="https://www.npmjs.com/package/build-a-npm" target="_blank">Build-a-NPM</a></p>
      </footer>
    </main>
  </div>
  <script>
