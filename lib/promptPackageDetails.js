...
async function promptPackageDetails(config = {}) {
  ...
  answers.dependencies = dependencyList.filter((dep) => dep.type === "dependency").reduce((acc, dep) => {
    acc[dep.name] = dep.version;
    return acc;
  }, {});
  answers.devDependencies = dependencyList.filter((dep) => dep.type === "devDependency").reduce((acc, dep) => {
    acc[dep.name] = dep.version;
    return acc;
  }, {});
